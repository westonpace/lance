...
type LockedBatchStream = Arc<tokio::sync::Mutex<BoxStream<'static, Result<RecordBatch>>>>;
...
impl LanceScanExec {
    pub async fn try_new(
        ...
        let batches = reader
            ...
            .boxed();
        let batches = Arc::new(tokio::sync::Mutex::new(batches));
